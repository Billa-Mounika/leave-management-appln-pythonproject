...
def auth():
    try:
        ...
        flash('Something went wrongauth', 'danger')
...
def updateEmployeeInfo():
    try:
        if request.method == 'POST':
            ...
            flash('Employee details edited successfully.','success' )
    ...
    try:
        if request.method == 'POST':
            ...
            if current_month==leave_month:
                ...
                available_monthly_leave = int(available_monthly_leave)
...
def approve_leave(emp_id):
    ...
    try:
        ...
        flash('Something went wrongLeaves', 'danger')
